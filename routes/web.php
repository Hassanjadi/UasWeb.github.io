...
Route::get('heading', 'App\Http\Controllers\Heading@index');
Route::get('heading/tambah', 'App\Http\Controllers\Heading@tambah');
Route::get('heading/edit/{par1}', 'App\Http\Controllers\Heading@edit');
Route::get('heading/detail/{par1}', 'App\Http\Controllers\Heading@detail');
// video
...
Route::get('admin/kategori/edit/{par1}', 'App\Http\Controllers\Admin\Kategori@edit');
Route::get('admin/kategori/delete/{par1}', 'App\Http\Controllers\Admin\Kategori@delete');
Route::post('admin/kategori/tambah_proses', 'App\Http\Controllers\Admin\Kategori@tambah_proses');
Route::post('admin/kategori/edit_proses', 'App\Http\Controllers\Admin\Kategori@edit_proses');
Route::post('admin/kategori/proses', 'App\Http\Controllers\Admin\Kategori@proses');
Route::get('admin/kategori/detail/{par1}', 'App\Http\Controllers\Admin\Kategori@detail');
