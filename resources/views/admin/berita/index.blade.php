...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    <h4 class="m-0 font-weight-bold text-primary">Data Berita
        <a href="{{ asset('admin/berita/tambah') }}" class="btn btn-sm btn-info float-right">
                                    ...
                                    <div class=" d-flex justify-content-between mb-4">
                                        <form class="d-none d-sm-inline-block form-inline ">
                                            <div class="input-group">
                                                <input type="text" class="form-control bg-light border-0 small" id="kata_kunci" name="keyword" placeholder="Search for..." aria-label="Search" aria-describedby="basic-addon2" value="<?php if(isset($_GET['keywords'])) { echo strip_tags($_GET['keywords']); } ?>" required>
...
<tr>
  ...
  <?php } ?>
    ...
    <td align="center">
        ...
        class="btn btn-info btn-circle" target="_blank"><i class="fas fa-info-circle"></i></a>

        <a href="{{ asset('admin/berita/edit/'.$berita->id_berita) }}" 
        class="btn btn-success btn-circle"><i class="fas fa-edit"></i></a>

        <a href="{{ asset('admin/berita/delete/'.$berita->id_berita.'/'.$berita->jenis_berita) }}" class="btn btn-danger btn-circle delete-link"><i class="fas fa-trash"></i></a>
